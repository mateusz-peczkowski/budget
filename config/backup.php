...
return [
    ...
    'notifications'   => [
        ...
        'slack' => [
            'webhook_url' => env('BACKUP_SLACK_WEBHOOK_URL', 'https://hooks.slack.com/'),
        ...
        'discord' => [
            'webhook_url' => env('BACKUP_DISCORD_WEBHOOK_URL', 'https://discord.com/api'),
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => 102400,
            ],
        ],
