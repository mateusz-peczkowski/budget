<template>
    ...
    >
        ...
        >
            ...
            <h2 v-if="expenses.length && Object.keys(expensesTypes).length" class="text-lg mt-6 mb-3">{{ __('Yearly Calculations') }}</h2>

            <Card class="relative" v-if="expenses.length && Object.keys(expensesTypes).length">
                <div class="overflow-hidden overflow-x-auto relative">
                    <table class="w-full divide-y divide-gray-100 rounded-lg">
                        ...
                        <tr>
                            <td colspan="3" class="bg-color-bottom">&nbsp;</td>
